        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card variant="glass" className="p-8">
              <div className="border-2 border-dashed border-slate-700 rounded-2xl p-12 text-center hover:border-cyan-500/50 transition-colors cursor-pointer">
            ...
            <Card variant="glass" className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-4 py-3 bg-slate-800 border border-slate-700 text-white placeholder-slate-500 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent resize-none"
                    rows={4}
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 bg-slate-800 border border-slate-700 text-white rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent">
                    <option>Beach</option>
          ...
          <div className="space-y-6">
            ...
            <Card variant="gradient" className="p-6">
              ...
              <div className="relative mb-6">
                <div className="w-32 h-32 rounded-full border-8 border-slate-700 mx-auto flex items-center justify-center">
